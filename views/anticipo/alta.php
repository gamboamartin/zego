<form action="index.php?seccion=anticipo&accion=alta_bd&session_id=<?php echo SESSION_ID; ?>" method="POST">
<div class="row">
<?php
echo $directiva->input_select('cliente',false,4,false,false,false,$controlador->link,'required',false);
echo $directiva->input_select('forma_pago',false,4,false,false,false,$controlador->link,'required',false);
echo $directiva->input_select('metodo_pago',false,4,false,false,false,$controlador->link,'required',false);
?>
</div>
    <div class="row">
        <?php
