...
<div class="container">
    ...
    <div class='col-md-12 row'>
        ...
        <?php echo $controlador->numero_texto.' '.$controlador->datos_comprobante['Moneda']; ?>
    </div>
</div>
...
<div class="col-md-12">
    ...
    ?>
    <a href="./index.php?seccion=factura&accion=timbra_cfdi&factura_id=<?php echo $controlador->factura_id; ?>">
