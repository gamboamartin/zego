...
<div class="col-md-12">
    ...
    <a href="./index.php?seccion=nota_credito&accion=elimina_nota_credito&nota_credito_id=<?php echo $controlador->nota_credito_id; ?>">
        <button type="button" class="btn">Elimina Nota de Credito</button>
    </a>
